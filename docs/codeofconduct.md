...
This Code of Conduct is based on the <a href="http://geekfeminism.wikia.com/wiki/Community_anti-harassment" target="_blank" class="external">example policy from the Geek Feminism wiki</a>, created by the Geek Feminism community.
